...
public class CS2ProgrammingWeek3 
{
	...
	{
		System.out.println("1: " + subCopies("catcowcat", "cat", 2));
		
		System.out.println("2: " + sumDigitsInNumber(1564));
		
		System.out.println("3: " + exponential(4, 4));
		
		System.out.println("4: " + changeXtoY("xhixhix"));
		
		int[] testArray = {0, 1, 4, 6, 7};
		System.out.println("5: " + find6(testArray, 0));
		
		System.out.println("6: " + insertAsterisk("helloworld"));
		
		System.out.println("7: " + numberPairs("axaxrstat"));
		
		System.out.println("8: " + reduceChars("abbbcddzz"));
		
		System.out.println("9: " + nestedParens("(((x))"));
		
		System.out.println("10: " + subStrSub("catxxcowxxtomcatxx", "cat"));
	}
