...
public class CS2Week2 
{
	...
	{
		int[] testArray1 = {5, 2, 3, 5, 6, 7};
		System.out.println("1: " + FindThreeIncreasingNumbers(testArray1));

		int[] testArray2 = {10, 1, 20, 2};
		System.out.println("2: " + Arrays.toString(multiplesOfTen(testArray2)));

		int[] testArray3 = {1, 2, 3, 2, 5, 2};
		System.out.println("3: " + Arrays.toString(CheckForAloneNumbers(testArray3, 2)));

		int[] testArray4 = {0, 1, 0};
		System.out.println("4: " + Arrays.toString(ReplaceZerosWithLargestOdd(testArray4)));

		System.out.println("5: " + Arrays.toString(CreateIncreasingArray(5, 10)));
	
		int[] testArray6 = {3, 1, 4};
		System.out.println("6: " + Arrays.toString(CopyNumbersBeforeFour(testArray6)));

		int[] testArray7 = {0, 1, 1, 0, 1};
		System.out.println("7: " + Arrays.toString(MoveZerosToFront(testArray7)));

		int[] testArray8 = {3, 3, 2};
		System.out.println("8: " + Arrays.toString(EvenFrontOddBack(testArray8)));
	}
